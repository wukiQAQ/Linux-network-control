...
var Features = []string{"history", "sessions", "alerts", "capture.dump", "actions.run", "files", "stream", "topn", "system.upgrade", "capture.multiqueue", "capture.filter", "plugins", "capture.cpupin"}
